...
if(isSet($_POST['getLastContentId'])) {
	...
	$result=mysql_query("SELECT * FROM `index` WHERE enraging <'$getLastContentId' ORDER BY enraging DESC LIMIT 10");
	...
	if($count>0){
		...
		<div enraging="<?php echo $enraging; ?>" class="more_button">Mehr Neuigkeiten laden</div></a>
		</div>
